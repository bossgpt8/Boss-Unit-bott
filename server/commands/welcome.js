    ...
    for (const participant of participants) {
        try {
            ...
            try {
                ...
                const apiUrl = `https://api.some-random-api.com/welcome/img/2/gaming3?type=join&textcolor=green&username=${encodeURIComponent(displayName)}&guildName=${encodeURIComponent(groupName)}&memberCount=${totalMembers}&avatar=${encodeURIComponent(profilePicUrl)}`;
