        ...
        try {
            ...
            if (customMessage) {
                finalMessage = customMessage
                    ...
                    .replace(/{count}/g, totalMembers.toString())
                    .replace(/{group}/g, groupName);
            } else {
                // Default message if no custom message is set
                finalMessage = `╭╼━≪•𝙻𝙴𝙰𝚅𝙴•≫━╾╮\n┃𝙶𝙾𝙾𝙳𝙱𝚈𝙴: @${displayName} 👋\n┃Remaining: #${totalMembers}\n╰━━━━━━━━━━━━━━━╯\n\n *@${displayName}* we will never miss you! `;
            }
            ...
            try {
                ...
                const apiUrl = `https://api.some-random-api.com/welcome/img/2/gaming1?type=leave&textcolor=red&username=${encodeURIComponent(displayName)}&guildName=${encodeURIComponent(groupName)}&memberCount=${totalMembers}&avatar=${encodeURIComponent(profilePicUrl)}`;
