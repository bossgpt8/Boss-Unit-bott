...
import { Bot, Zap, Shield, Users, MessageCircle, Sparkles, Mail, Lock, User, ArrowRight } from "lucide-react";
        ...
        <div className="flex-1 p-8 lg:p-20 flex flex-col justify-between overflow-hidden">
          ...
          >
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[10px] font-bold text-gray-500 uppercase tracking-[0.3em] mt-1">Unit 3.0</span>
            </div>
          </motion.div>
          ...
          <div className="max-w-xl py-12 lg:py-0">
            ...
            >
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 mb-6 backdrop-blur-md">
                ...
                <span className="text-[10px] font-bold text-purple-300 uppercase tracking-widest">Version 3.0 Live</span>
              </div>
              ...
              <p className="text-lg text-gray-400 leading-relaxed mb-10 max-w-md">
                The world's most advanced WhatsApp automation ecosystem. 100+ commands, AI integration, and total group dominance.
              </p>
          ...
          >
            &copy; 2024 Boss Unit Bot • Designed by Israel
          </motion.div>
        </div>
            ...
            <div className="space-y-4">
              ...
              <div className="relative py-4">
                ...
                <div className="relative flex justify-center text-xs uppercase font-bold tracking-widest">
                  <span className="bg-[#04040a] px-4 text-gray-600">Or via Email</span>
                </div>
              </div>
