  ...
  return (
    <div className="cyber-card p-6 border-white/10 bg-white/10 backdrop-blur-2xl relative overflow-hidden">
      ...
      <div className="flex flex-col md:flex-row gap-6 items-start justify-between relative z-10 mb-6">
        <div>
          <h2 className="text-3xl font-display font-bold tracking-tighter mb-1 text-white uppercase italic">System <span className="text-primary">Control</span></h2>
          <div className="flex items-center gap-2">
            <span className="text-gray-400 font-mono text-[10px] uppercase tracking-widest font-bold opacity-100">Platform Identity:</span>
            <span className="text-primary font-display font-bold text-sm tracking-wider">BOSS UNIT</span>
          </div>
          <div className="flex items-center gap-2 mt-2">
            <span className="text-gray-400 font-mono text-[10px] uppercase tracking-widest font-bold opacity-100">Connection State:</span>
            <span className={`px-4 py-1 rounded-full text-[10px] font-black uppercase tracking-[0.2em] border shadow-xl ${
              isOnline ? 'bg-green-500/20 text-green-400 border-green-500/40 animate-pulse' : 
              status === 'error' ? 'bg-red-500/20 text-red-400 border-red-500/40' :
          ...
          <AnimatePresence mode="wait">
            {isOnline ? (
              ...
              >
                ...
                <p className="text-muted-foreground font-mono text-[10px] uppercase tracking-widest mb-2 font-bold">Pairing Code</p>
                <div 
                ...
                >
                  <span className="text-2xl font-display font-bold text-primary tracking-widest">{pairingCode}</span>
      ...
      <div className="grid grid-cols-2 gap-4 relative z-10">
        <div className="p-4 bg-black/40 border border-white/10 rounded-2xl group hover:border-primary/50 transition-all duration-300">
          <div className="text-[10px] text-gray-400 uppercase tracking-[0.2em] mb-1 font-bold">Bot Uptime</div>
          <div className="text-2xl font-display font-bold text-primary">{isOnline ? formatUptime(uptime) : "00:00:00"}</div>
        </div>
        <div className="p-4 bg-black/40 border border-white/10 rounded-2xl group hover:border-primary/50 transition-all duration-300">
          <div className="text-[10px] text-gray-400 uppercase tracking-[0.2em] mb-1 font-bold">Network Link</div>
